...
function page(url) {
  ...
  const title = o ? sentence(o) : 'Opine — options in a sentence'
  const desc = o ? `Agree or disagree on Derive. Copy this opinion or take the other side.` : 'Say what you think. Buy or sell the option that says it.'
