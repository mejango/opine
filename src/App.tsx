      ...
      <div className={`card ${stance}`}>
        ...
        <div className="limit">
          {limit == null
            ...
            : <label>
                $<input type="text" inputMode="decimal" value={limit} onChange={(e) => setLimit(e.target.value.replace(/[^\d.]/g, ''))} style={{ width: `${Math.max(1, limit.length) + 0.5}ch` }} autoFocus /> each, rests until filled.
